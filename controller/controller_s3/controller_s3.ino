...
#define JOYSTICK_NORTH_PIN   38   // ジョイスティック上
#define JOYSTICK_SOUTH_PIN   36   // ジョイスティック下  
#define JOYSTICK_WEST_PIN    39  // ジョイスティック左
#define JOYSTICK_EAST_PIN    37  // ジョイスティック右

#define BUTTON_1_PIN        13  // ボタン1
#define BUTTON_2_PIN        12  // ボタン2
#define BUTTON_3_PIN        11 // ボタン3
#define BUTTON_4_PIN        10  // ボタン4
